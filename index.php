...
<body style="background-color: #6B7C76;">
    <!--holds the landing page-->
    <div class="container-fluid overflow-hidden Mainlandpage">
        <div>
            <!--logo container-->
                ...
                <div class="row">
                    <div class="col-6">
                        <div>
                            <div class="intro">
                                <h1>
                                    A peaceful life leads to a fullfiled life
                                </h1>

                                <p>
                                    Be kind to your mind. Being able to be your true self is one of the strongest components of good mental health
                                </p>
