    ...
    <section class="p-4 my-container ">
        <div class="appointment_list container-fluid">
            <div class="table-responsive">
                <h1 class="text-center text-black">CARE TEAM</h1>
                <table class="table table-striped table-hover table-bordered" style= "margin-top: 3rem;">
                    ...
                    <?php
                        ...
                        $select_care_team_data = "SELECT `client_id`, `therapist_id` FROM `assigned_therapist`;";
                        $select_care_team_result = mysqli_query($conn, $select_care_team_data);
                        //print_r($select_care_team_result);
                        $i = 0;
                        if($select_care_team_result){
                            while ($row  = mysqli_fetch_assoc($select_care_team_result)) { //fetch array
                                $i++;
                                ...
                                $selectclient= "SELECT  `client_name`,  `email` FROM `client_info` WHERE `client_id` = '$clientinformation';";
                    ...
                    <tr>
                        ...
                        <td><?php echo $rows['therapist_name'];?></td>
                        <td><?php echo $rows['email'];?></td>
                    </tr>
                    <?php 
                            }
