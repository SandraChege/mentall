...
if(isset($_POST['submit'])){
    ...
    if($anxiety > $depression && $anxiety > $ptsd){
        $diagnosis = "Anxiety";
    }
    if($ptsd > $anxiety && $ptsd > $depression){
        $diagnosis = "Ptsd";
    }
    echo $diagnosis;
    $id = $_SESSION['id'];
    ...
    if(mysqli_num_rows($result_check) == 0){
        ...
        if ($result_insert){
            header(("location:diagnois.php?message= Your diagnosis has been made. A therapist will be assigned to you"));
        }
    }
