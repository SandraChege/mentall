        ...
        <div>
            <!--logo and navbar container-->
                ...
                <div class="container-fluid" id="Qatherapist-form">
                    <form action="clientchoosetherapydb.php" method="post" class="quiz-container" id="quiz">
                        <!--Question 1-->
                        <div class="question-container" style="margin-top:30px;">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="emotions" id="" value="5">
                                <label class="form-check-label" for="">1-Very bad</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="emotions" id="" value= "4">
                                <label class="form-check-label" for="">2-Bad</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="emotions" id="" value = "3">
                                <label class="form-check-label" for="">3-Neutral</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="emotions" id="" value = "2">
                                <label class="form-check-label" for="">4-Good</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="emotions" id="" value = "1">
                        ...
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sadness" id="" value = "5">
                                <label class="form-check-label" for="">1-Very often</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sadness" id="" value = "4">
                                <label class="form-check-label" for="">2-Often</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sadness" id="" value = "3">
                                <label class="form-check-label" for="">3-Sometimes</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sadness" id="" value = "2">
                                <label class="form-check-label" for="">4-Rarely</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sadness" id="" value = "1">
                        ...
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="worry" id="" value = "5">
                                <label class="form-check-label" for="">1-Very frequently</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="worry" id="" value = "4">
                                <label class="form-check-label" for="">2-Frequently</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="worry" id="" value = "3">
                                <label class="form-check-label" for="">3-Occasionally</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="worry" id="" value = "2">
                                <label class="form-check-label" for="">4-Rarely</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="worry" id="" value= "1">
                                <label class="form-check-label" for="">5-Never</label>
                            </div>
                        </div>
                        <!--Question 4-->
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="interest" id="" value = "5">
                                <label class="form-check-label" for="">1- A lot of difficulty</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="interest" id="" value = "4">
                                <label class="form-check-label" for="">2-Moderate difficulty</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="interest" id="" value = "3">
                                <label class="form-check-label" for="">3-Some difficulty</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="interest" id="" value = "2">
                                <label class="form-check-label" for="">4-Little difficulty</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="interest" id="" value = "1">
                        ...
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="intrusive" id="" value = "5">
                                <label class="form-check-label" for="">1-Very often</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="intrusive" id="" value = "4">
                                <label class="form-check-label" for="">2-Often</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="intrusive" id="" value = "3">
                                <label class="form-check-label" for="">3-Sometimes</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="intrusive" id="" value = "2">
                                <label class="form-check-label" for="">4-Rarely</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="intrusive" id="" value = "1">
                                <label class="form-check-label" for="">5-Never</label>
                            </div>
                        </div>
                        <!--Question 6-->
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="decision" id="" value = "5">
                                <label class="form-check-label" for="">1- A lot of struggle</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="decision" id="" value = "4">
                                <label class="form-check-label" for="">2-Moderate struggle</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="decision" id="" value = "3">
                                <label class="form-check-label" for="">3-Some struggle</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="decision" id="" value = "2">
                                <label class="form-check-label" for="">4-Little struggle</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="decision" id="" value = "1">
                        ...
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="agitated" id="" value = "5">
                                <label class="form-check-label" for="">1-Very frequently</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="agitated" id="" value = "4">
                                <label class="form-check-label" for="">2-Frequently</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="agitated" id="" value = "3">
                                <label class="form-check-label" for="">3-Occasionally</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="agitated" id="" value = "2">
                                <label class="form-check-label" for="">4-Rarely</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="agitated" id="" value = "1">
                                <label class="form-check-label" for="">5-Never</label>
                            </div>
                        </div>
                        <!--Question 8-->
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="physical" id="" value = "5">
                                <label class="form-check-label" for="">1-Very often</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="physical" id="" value = "4">
                                <label class="form-check-label" for="">2-Often</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="physical" id="" value = "3">
                                <label class="form-check-label" for="">3-Sometimes</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="physical" id="" value = "2">
                                <label class="form-check-label" for="">4-Rarely</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="physical" id="" value = "1">
                                <label class="form-check-label" for="">5-Never</label>
                            </div>
                        </div>
                        <!--Question 9-->
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sleep" id="" value = "5">
                                <label class="form-check-label" for="">1- A lot of difficulty</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sleep" id="" value = "4">
                                <label class="form-check-label" for="">2-Moderate difficulty</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sleep" id="" value = "3">
                                <label class="form-check-label" for="">3-Some difficulty</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sleep" id="" value = "2">
                                <label class="form-check-label" for="">4-Little difficulty</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="sleep" id="" value = "1">
                                <label class="form-check-label" for="">5-No difficulty</label>
                            </div>
                        </div>
                        <!--Question 10-->
                        <div class="question-container">
                            ...
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="life" id="" value = "5">
                                <label class="form-check-label" for="">1-Very dissatisfied</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="life" id="" value = "4">
                                <label class="form-check-label" for="">2-Dissatisfied</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="life" id="" value = "3">
                                <label class="form-check-label" for="">3-Neutral</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="life" id="" value = "2">
                                <label class="form-check-label" for="">4-Satisfied</label>
                            </div>
                            <div class="quiz-answers form-check">
                                <input class="form-check-input" type="radio" name="life" id="" value = "1">
